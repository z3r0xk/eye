    ...
    <header className="flex flex-col sm:flex-row items-center justify-between gap-4 p-3 bg-slate-800/50 backdrop-blur-sm rounded-lg border border-slate-700 shadow-xl">
      ...
      <div className="w-full sm:w-auto max-w-md">
        <input
          ...
          className="w-full px-3 py-1.5 bg-slate-700/50 text-slate-100 rounded-lg border border-slate-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent placeholder-slate-400"
        />
      </div>
    </header>
  );
